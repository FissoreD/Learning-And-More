...
export default class Home extends React.Component<PropReact, {}> {
  ...
  render(): React.ReactNode {
    return <>
      ...
      <h3>Automata</h3>
      <p>
        The <a onClick={() => this.props.switchSection("Automaton")} href="#">Automaton</a> section aims to represent regular finite state machines and visibly pushdown automata. <br />
