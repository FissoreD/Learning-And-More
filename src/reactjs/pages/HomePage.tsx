...
class HomePage extends React.Component<PropReact, {}> {
  render(): React.ReactNode {
    return <div style={{ overflow: "hidden" }}>
      ...
      <h3 >Automata</h3>
      <p>
        The <button onClick={() => this.props.setCurrentPage("Automaton")}>Automaton</button> section aims to represent regular finite state machines and visibly pushdown automata. <br />
