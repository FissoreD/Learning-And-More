...
(function (noam) {
  ...
  (function () {
    ...
    noam.fsm.convertStatesToNumbers = function (fsm) {
      ...
      for (let i = 0; i < fsm.acceptingStates.length; i++) {
      ...
      for (let i = 0; i < fsm.transitions.length; i++) {
        ...
        for (let j = 0; j < fsm.transitions[i].toStates.length; j++) {
              ...
              if (tree.elements[i].tag === tags.KSTAR) {
                if (
                  ...
                  if (index_eps >= 0) {
                    ...
                    fsm_kstar = getFromCacheOrCreateFsm(
                      tree.elements[i],
                      fsmCache
                    );
                    fsm_other = getFromCacheOrCreateFsm(
                      tree.elements[i + 1],
                      fsmCache
                    );
